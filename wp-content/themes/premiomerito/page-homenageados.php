...
<section class="page page-homenageados container-fluid">
	...
	<div class="row	merito-title-pagina">
		<div class="container">
			...
			<select id="select-edicao" class="ani-04 bg-cor-1 bg-cor-2-hover" name="ano" data-p="homenageados" <?php echo ( $ano != '' ) ? 'data-s="' . $ano . '"' : ''; ?> <?php echo ( count( $arEdicoes ) <= 1 ) ? 'disabled' : ''; ?>>
				<?php
