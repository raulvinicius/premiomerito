    ...
    <body>
        ...
        <header>
            ...
            <nav>
                        ...
                        <div class="col-md-4">
                            <a class="logo" href="<?php bloginfo('url') ?>">
                                ...
                                <svg version="1.1"
                                     ...
                                     xml:space="preserve"  class="ani-02">
                                <style type="text/css">
                ...
                <?php 
                    ...
                    while ( $homenageados->have_posts() ) :
                        ...
                        for ($i=0; $i < count($edicao); $i++) { 
                            $arEdicoesHomenageados[] = array(
                                'id' => $edicao[$i],
                                'name' => get_term_by('id', $edicao[$i], 'tag-edicoes')->name
                            );
                        }
                ...
                <div class="container-fluid menu ani-02">
                    <div class="container">
                        
                        <div class="row">
                            <div class="ani-04 col-md-offset-1 col-md-10">
                                <ul>
                                    <li>
                                    <a href="<?php bloginfo('url') ?>/sobre" class="merito-bt bg-cor-1-hover ani-04">O Prêmio Mérito</a>
                                        ...
                                        <ul>
                                            ...
                                            <?php for ($i=0; $i<count($arEdicoesHomenageados); $i++): ?>
                                                ...
                                                <li class="ani-04 bg-cor-1 bg-cor-2-hover">
                                                    <a href="<?php echo bloginfo('url') ?>/homenageados/<?php echo $arEdicoesHomenageados[$i]['name'] ?>">
                                        ...
                                        <ul>
                                            ...
                                            <?php for ($i=0; $i<count($arEdicoesFotos); $i++): ?>
                                                ...
                                                <li class="ani-04 bg-cor-1 bg-cor-2-hover">
                                                    <a href="<?php echo bloginfo('url') ?>/fotos/<?php echo $arEdicoesFotos[$i]['name'] ?>">
                                        ...
                                        <ul>
                                            ...
                                            <?php for ($i=0; $i<count($arEdicoesLivros); $i++): ?>
                                                ...
                                                <li class="ani-04 bg-cor-1 bg-cor-2-hover">
                                                    <a href="<?php echo bloginfo('url') ?>/livros/<?php echo $arEdicoesLivros[$i]['name'] ?>">
