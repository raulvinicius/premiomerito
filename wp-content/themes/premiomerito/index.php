	...
	<section class="container-fluid homenageados">
	    <div class="container">
	        <div class="row">
	            ...
	            <div class="col-md-6">
	                <h2>Homenageados <span>por categoria</span></h2>
	            </div>
	            ...
	            <div class="col-md-6">
	                <ul>
	                    ...
	                    <div class="row">
	                        <li class="ani-06 col-md-5 col-md-offset-1">
	                            <a href="<?php bloginfo('url') ?>/homenageados/#atendimento">

	                            	<!-- Generator: Adobe Illustrator 19.2.1, SVG Export Plug-In  -->
	                            	<svg version="1.1"
	                            		 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
	                            		 x="0px" y="0px" width="67px" height="64px" viewBox="0 0 522.4 503.5" style="enable-background:new 0 0 522.4 503.5;"
	                            		 xml:space="preserve">
	                            	<style type="text/css">
	                            		.sth0{fill:white;}
	                            	</style>
	                        ...
	                        <li class="ani-06 col-md-5">
	                            <a href="<?php bloginfo('url') ?>/homenageados/#crescimento">

	                            	<!-- Generator: Adobe Illustrator 19.2.1, SVG Export Plug-In  -->
	                            	<svg version="1.1"
	                            		 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
	                            		 x="0px" y="0px" width="56px" height="64px" viewBox="0 0 42 48" style="enable-background:new 0 0 42 48;" xml:space="preserve">
	                            	<style type="text/css">
	                            		.sth0{fill:white;}
	                            	</style>
	                            	<defs>
	                    ...
	                    <div class="row">
	                        <li class="ani-06 col-md-5 col-md-offset-1">
	                            <a href="<?php bloginfo('url') ?>/homenageados/#criatividade">

	                            	<!-- Generator: Adobe Illustrator 19.2.1, SVG Export Plug-In  -->
	                            	<svg version="1.1"
	                            		 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
	                            		 x="0px" y="0px" width="45px" height="64px" viewBox="0 0 34.1 48" style="enable-background:new 0 0 34.1 48;"
	                            		 xml:space="preserve">
	                            	<style type="text/css">
	                            		.sth0{fill:white;}
	                            	</style>
	                        ...
	                        <li class="ani-06 col-md-5">
	                            <a href="<?php bloginfo('url') ?>/homenageados/#personalidade">

	                            	<!-- Generator: Adobe Illustrator 19.2.1, SVG Export Plug-In  -->
	                            	<svg version="1.1"
	                            		 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
	                            		 x="0px" y="0px" width="63px" height="64px" viewBox="0 0 47.4 48" style="enable-background:new 0 0 47.4 48;"
	                            		 xml:space="preserve">
	                            	<style type="text/css">
	                            		.sth0{fill:white;}
	                            	</style>
	...
	<section class="container-fluid edicoes-anteriores">
	    <div class="container">
	        <div class="row">
	            ...
	            <div class="col-md-5">
	                <h2>Edições <span class="cor-1">anteriores</span></h2>
	            </div>
	            ...
	            <div class="col-md-7">
	                <ul>
	                    ...
	                    <div class="row">
	                        ...
	                        <li class="col-md-3">
	                            <a href="<?php bloginfo('url') ?>/homenageados/?ano=2014">
	                        ...
	                        <li class="col-md-3">
	                            <a href="<?php bloginfo('url') ?>/fotos/?ano=2011">
	                                <h3 class="ani-04">20<span class="cor-1 ani-04">11</span></h3>
	                                <p>Museu da República</p>
	                            </a>
	                        </li>

	                        <li class="col-md-3">
	                            <a href="<?php bloginfo('url') ?>/fotos/?ano=2010">
	                                <h3 class="ani-04">20<span class="cor-1 ani-04">10</span></h3>
	                                <p>Museu da República</p>
	                            </a>
	                        </li>

	                        <li class="col-md-3">
	                            <a href="<?php bloginfo('url') ?>/fotos/?ano=2008">
	                                <h3 class="ani-04">20<span class="cor-1 ani-04">08</span></h3>
	                                <p>Museu da República</p>
	                            </a>
	                        </li>
	                    </div>
